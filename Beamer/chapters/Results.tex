...
\section{Numerical Results}
    ...
    \begin{frame}{Performances of Different Policies to Optimal}
        ...
        \end{table}
          ...
          We compare the performance of different policies to the optimal value. Specifically, we evaluate four policies for seat assignment for each group arrival: stochastic planning policy, bid-price control, dynamic programming base-heuristic and first-come, first-served (FCFS).
    \end{frame}
    ...
    \end{figure}
    \scriptsize
    Blue points: the first period that shows the difference.
    
    Red points: percentage of total seats at the corresponding period. 
    \end{frame}