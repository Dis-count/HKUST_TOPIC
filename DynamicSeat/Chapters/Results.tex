...
\subsection{Methods Versus Optimal Versus FCFS}
...
Probability 3: $[0.1, 0.4, 0.4, 0.1]$,
Probability 4: $[0.5, 0.2, 0.2, 0.1]$.
...
\begin{figure}[h]
  \centering
  \subfigure[Probability 3]{
    \includegraphics[width=0.48\textwidth]{./Figures/p3.pdf}}
  \subfigure[Probability 4]{
    \includegraphics[width=0.48\textwidth]{./Figures/period_4.pdf}}
  \caption{The number of people served versus periods}
\end{figure}
...
With the conclusion of the last section, we can estimate the attendance rate from $\frac{c}{c+1}*$ the number of seats. The number of periods will be $E(D)/c$.


The government can make the policy on how much attendance rate can be established.
