...
In this section, we discuss dynamic seat assignment based on stochastic assignment policy (SAP), which incorporates group-type control to optimize resource utilization.
