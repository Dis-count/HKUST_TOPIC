...
\begin{lem}
 Let $\mathbf{X}$ be the solution of LP relaxation of problem \eqref{relax_deter}. $\mathbf{X}$ is the same as the aggregate solution of LP relaxation of problem \eqref{deter_upper}.
\end{lem}
