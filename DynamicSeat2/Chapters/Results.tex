...
%  最晚的时间 差距不超过 1 
%  The average of 
In this section, our focus is to analyze the influence of social distancing on the number of accepted individuals. Our primary objective is to determine the latest time period at which the number of people accepted without social distancing is less than the number accepted with social distancing plus one. This critical point, referred to as the gap point, is of interest to us. Additionally, we will examine the corresponding occupancy rate at this gap point.
