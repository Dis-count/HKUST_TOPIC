...
\subsection{Running time of solving SSP and relaxation of SSP with Benders Decomposition}\label{Bender_IP}
...
\begin{table}[ht]
  \centering
  \scriptsize
  \caption{Running time of solving SSP and relaxation of SSP with Benders Decomposition}\label{tab_1}
...
The parameters in the columns of the table are the number of scenarios, the range of demands, running time of SSP, running time of Benders decomposition method, the number of rows, the number of group types and the number of seats for each row, respectively. 
