...
\subsection{Performances of Different Policies to Optimal}
...
\begin{table}[ht]
  \centering
  \caption{Performances of Different Policies to Optimal}
  \begin{tabular}{|l|l|l|l|l|l|l|}
  \hline
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.8\textwidth]{./Figures/scatter.pdf}
