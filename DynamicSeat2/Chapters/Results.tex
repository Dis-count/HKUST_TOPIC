...
In this section, our focus is to analyze the influence of social distancing on the number of accepted individuals. Our primary objective is to determine the earliest time period at which the number of people accepted without social distancing surpasses the number accepted with social distancing. This critical point, referred to as the "gap point," is of interest to us. Additionally, we will examine the corresponding occupancy rate at this gap point.
...
\begin{table}[ht]
  ...
  \hline
  1.9   & [67, 63.37] & 0.25 &  5.82 & 12.82 & 20.38 & 24.56 \\
  2.1   & [64, 66.74] & 0.05 & 4.11 & 11.51 & 18.77 & 21.87 \\
