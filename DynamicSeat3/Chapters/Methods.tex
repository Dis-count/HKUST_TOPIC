...
% to A Specific Row
% We determine whether to place the group arrival in a specific row based on the values of the stochastic programming problem. 
...
% If the row does not exist, we assign the group at a row that contains the larger group and have the smallest remaining capacity.
