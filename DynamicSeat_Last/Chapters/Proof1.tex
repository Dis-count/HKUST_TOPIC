...
Suppose that $H$ is the seat plan associated with the optimal solution to SSP, but there exists a pattern that is neither full nor the largest. The corresponding excess of supply is $\mathbf{y}^{+}$. According to Proposition \ref{prop_construction}, $H{'}$ can be obtained from $H$. The seat plan, $H{'}$, is composed of full or largest patterns and satisfies all constraints of SSP. The corresponding excess of supply is $\mathbf{y}^{'+}$.
