...
% determine the first time period at which, on average, the number of people accepted without social distancing is not less than the number accepted with social distancing plus one. 
...
\section{Impact of Social Distancing in DSA}
...
\begin{figure}[h]
  ...
  \subfigure[]{
    \label{Fig.sub.1}
    \includegraphics[width=0.48\textwidth]{./Figures/without7.pdf}}
  \subfigure[]{
    \label{Fig.sub.2}
