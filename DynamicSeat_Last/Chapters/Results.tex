...
We experiment with several realistic seat layouts from cinema websites.
% https://www.cinema.com.hk/

% We do the following procedure on the layout.

% The seats on the side can be regarded as the new rows.
