...
\begin{figure}[h]
  \centering
  \subfigure[Layout 1]{
    \includegraphics[width=0.48\textwidth]{./Figures/layout20.pdf}}
  \subfigure[Layout 3]{
    \includegraphics[width=0.48\textwidth]{./Figures/layout15.pdf}}
  \caption{The occupancy rate over demand with large and small rooms}
\end{figure}

\begin{figure}[h]
  \centering
  \subfigure[Layout 2]{
    \includegraphics[width=0.48\textwidth]{./Figures/group4.pdf}}
  \subfigure[Layout 4]{
    \includegraphics[width=0.48\textwidth]{./Figures/layout_fan.pdf}}
  \caption{The occupancy rate over demand with rectangular and fan-shaped layouts}
\end{figure}
