...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.6\textwidth]{./Figures/conversion0.pdf}
...
Given a feasible seat planning $\bm{H}$, the solution to problem \eqref{improve_seat} corresponds to a seat planning $\bm{H}^{\prime}$ such that $\bm{H}^{\prime} \supseteq \bm{H}$ and $\bm{H}^{'}$ is composed of full or largest patterns.
\end{prop}
