...
Given a feasible seat planning $\bm{H}$, problem \eqref{improve_seat} can always generate a seat planning $\bm{H}^{\prime}$ such that $\bm{H}^{\prime} \supseteq \bm{H}$ and $\bm{H}^{'}$ is composed of full or largest patterns.
\end{prop}
