...
Then we have the formulation of SSP:
  ...
  & y_{i \omega}^{+}, y_{i \omega}^{-} \in \mathbb{Z}^{+}, \quad i \in \mathcal{M}, \omega \in \Omega \notag \\
  & x_{ij} \in \mathbb{Z}^{+}, \quad i \in \mathcal{M}, j \in \mathcal{N} \notag.
  \end{align}
