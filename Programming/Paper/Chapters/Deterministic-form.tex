...
\begin{table}[ht]
  ...
  1000  & 50  & [0.4,0.4,0.1,0.1] & 8 & (95.86, 95.86, 96.26, 96.26) \\
  ...
  1000  & 40  & [0.25,0.25,0.25,0.25] & 8 & (99.84, 99.84, 100.12, 100.12) \\
  1000  & 45  & [0.25,0.25,0.25,0.25] & 8 & (109.9, 109.9, 111.34, 111.24) \\
  1000  & 50  & [0.25,0.25,0.25,0.25] & 8 & (101.5, 111.18, 111.26, 113.74, 114.74) \\
  ...
  10000 & 350  & [0.25,0.25,0.25,0.25] & 30 & (850.18, 850.2, 855.84, 855.84) \\
  \hline
  \end{tabular}
\end{table}
...
2. The supply is obtained from stochastic model.(IP)
