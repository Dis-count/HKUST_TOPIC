...
\begin{figure}[h]
	\centering  
	\includegraphics[width = 0.9\textwidth]{Figures/IP1.png}  %插入的图，包括JPG,PNG,PDF,EPS等，放在源文件目录下
	\caption{}  %图片的名称
	\label{fig:IP1}   %标签，用作引用
\end{figure}

\begin{figure}[h]
	\centering  
	\includegraphics[width = 0.9\textwidth]{Figures/IP2.png}  %插入的图，包括JPG,PNG,PDF,EPS等，放在源文件目录下
	\caption{}  %图片的名称
	\label{fig:IP2}   %标签，用作引用
\end{figure}
...
\begin{table}[ht]
  ...
  1000  & 30  & [0.4,0.4,0.1,0.1] & 8 & (53.08, 55.46, 53.8) \\
  1000  & 35  & [0.4,0.4,0.1,0.1] & 8 & (66.22, 65.9, 65.88) \\
  1000  & 40  & [0.4,0.4,0.1,0.1] & 8 & (73.98, 73.96, 73.58) \\
  1000  & 45  & [0.4,0.4,0.1,0.1] & 8 & (84.62,84.14,83.86) \\
  1000  & 50  & [0.4,0.4,0.1,0.1] & 8 & (93.56,93.94,92.74) \\
  1000  & 55  & [0.4,0.4,0.1,0.1] & 8 & (98.12,101.86,101.02) \\
  1000  & 60  & [0.4,0.4,0.1,0.1] & 8 & (101.68,104.24,103.6) \\
  5000  & 40  & [0.4,0.4,0.1,0.1] & 8 & (76.62,75.98,75.66) \\
  \hline
  1000  & 25  & [0.25,0.25,0.25,0.25] & 8 & (60.80, 62.12, 60.06) \\
  1000  & 30  & [0.25,0.25,0.25,0.25] & 8 & (73.08, 75.2, 72.96) \\
  1000  & 35  & [0.25,0.25,0.25,0.25] & 8 & (88.24, 87.52, 86.38) \\
  1000  & 40  & [0.25,0.25,0.25,0.25] & 8 & (98.56, 98.08, 96.94)  \\
  1000  & 45  & [0.25,0.25,0.25,0.25] & 8 & (108.82, 111.06, 109.5) \\
  1000  & 50  & [0.25,0.25,0.25,0.25] & 8 & (110.82,114.10,113.26) \\
  5000  & 30  & [0.25,0.25,0.25,0.25] & 8 & (73.5,74.32,72.64)  \\
  10000  & 30  & [0.25,0.25,0.25,0.25] & 8 & (74.84,75.04,73.14) \\
  \hline
  5000  & 300  & [0.25,0.25,0.25,0.25] & 30 & (751.96,750.60,749.72) \\
  5000  & 350  & [0.25,0.25,0.25,0.25] & 30 & (848.96,856.1,855.54) \\
  5000  & 400  & [0.25,0.25,0.25,0.25] & 30 & (871.46, 862.94, 862.92) \\
  5000  & 450  & [0.25,0.25,0.25,0.25] & 30 & (896.04, 871.28, 871.18) \\
  10000  & 350  & [0.25,0.25,0.25,0.25] & 30 & (849.92, 857.14, 857.0) \\
  \hline
  \end{tabular}
\end{table}

Stochastic solution works better when demand is less than supply but works worse when demand is larger than supply. The results are shown in the table.

(1,2,3) in the 'people served in the table: 
1: use the supply from stochastic model. 
2: the inital supply from stochastic model, update the supply by deterministic model. 
3: set the mean demand as the initial supply, update the supply by deterministic model. 
