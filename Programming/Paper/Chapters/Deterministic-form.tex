...
\begin{table}[ht]
  ...
  \hline
  \# of samples & T & prob & \# of rows & groups served (once, several)& \# of seats taken \\
  1000  & 100 & (0.4,0.4,0.1,0.1) & 7 & [5,33,6,7], [20,23,6,7] & (168,168) \\
  1000  & 150 & (0.4,0.4,0.1,0.1) & 7 & [4,21,10,11], [22,17,7,9] & (166, 168)\\
  5000  & 100 & (0.4,0.4,0.1,0.1) & 7 & [6,30,8,6], [26,18,8,6] & (164,169)\\
  5000  & 150 & (0.4,0.4,0.1,0.1) & 7 & [3,18,12,12], [19,15,5,13] & (168,168)\\
  \hline
  1000  & 100 & (0.25,0.25,0.25,0.25) & 7 & [0,0,17,20], [3,10,8,20] & (168, 168)\\
  1000  & 100 & (0.25,0.25,0.25,0.25) & 10 & [7,17,20,22], [10,18,14,25] & (255, 255)\\
  1000  & 150 & (0.25,0.25,0.25,0.25) & 10 & [2,2,20,33], [7,8,8,37] & (255, 255)\\
  5000  & 100 & (0.25,0.25,0.25,0.25) & 7 & [0,0,17,20], [3,10,8,20] & (168, 168)\\
  5000  & 150 & (0.25,0.25,0.25,0.25) & 7 & [0,0,17,20], [2,1,5,28] & (168, 167)\\
  5000  & 150 & (0.25,0.25,0.25,0.25) & 10 & [2,2,20,33], [9,11,11,32] & (255, 255)\\
  \hline
  \end{tabular}
\end{table}

Once: Obtain the supply from the stochastic model. Then use the several-class rule to decide whether to accept the group at each period.
...
Fix the number of seats for each row: $[21, 22, \ldots, 20 + \text{the number of rows}]$.
