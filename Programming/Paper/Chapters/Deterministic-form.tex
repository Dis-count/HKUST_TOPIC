...
\begin{table}[ht]
  ...
  1000  & 30  & [0.4,0.4,0.1,0.1] & 8 & (56.72, 56.72, 56.72, 56.72) \\
  1000  & 35  & [0.4,0.4,0.1,0.1] & 8 & (68.06, 68.06, 68.06, 68.06) \\
  1000  & 40  & [0.4,0.4,0.1,0.1] & 8 & (75.74, 75.74, 75.74, 75.74) \\
  1000  & 45  & [0.4,0.4,0.1,0.1] & 8 & (85.06, 85.06, 85.06, 85.06) \\
  1000  & 50  & [0.4,0.4,0.1,0.1] & 8 & (94.82, 94.82, 95.32, 95.32) \\
  1000  & 55  & [0.4,0.4,0.1,0.1] & 8 & (100.28, NA, 103.04, 103.06) \\ % slow
  1000  & 60  & [0.4,0.4,0.1,0.1] & 8 & (102.16, NA, 104.5, 104.5) \\
  5000  & 40  & [0.4,0.4,0.1,0.1] & 8 & (75.72, 75.72, 75.72, 75.72) \\
  \hline
  1000  & 25  & [0.25,0.25,0.25,0.25] & 8 & (61.66, 61.66, 61.66, 61.66) \\
  1000  & 30  & [0.25,0.25,0.25,0.25] & 8 & (76.52, 76.52, 76.52, 76.52) \\
  1000  & 35  & [0.25,0.25,0.25,0.25] & 8 & (87.82, 87.82, 87.82, 87.82) \\
  1000  & 40  & [0.25,0.25,0.25,0.25] & 8 & (100.56, 100.48, 100.7, 100.7) \\
  1000  & 45  & [0.25,0.25,0.25,0.25] & 8 & (107.26, 107.26, 109.5, 109.5) \\
  1000  & 50  & [0.25,0.25,0.25,0.25] & 8 & (112.28, 112.46, 114.36, 114.38) \\
  5000  & 30  & [0.25,0.25,0.25,0.25] & 8 & (74.48, 74.48, 74.48, 74.48) \\
  \hline
  5000  & 300  & [0.25,0.25,0.25,0.25] & 30 & (752.32, 752.32, 752.32, 752.32) \\
  5000  & 350  & [0.25,0.25,0.25,0.25] & 30 & (851.82, 851.78, 857.78, 857.78) \\
  5000  & 400  & [0.25,0.25,0.25,0.25] & 30 & (873.14, 873.42, 864.4, 864.4) \\
  5000  & 450  & [0.25,0.25,0.25,0.25] & 30 & (896.16, 896.6, 871.32, 871.32) \\
  10000 & 350  & [0.25,0.25,0.25,0.25] & 30 & (849.92, 857.14, 857.0) \\
  \hline
  \end{tabular}
\end{table}

The stochastic model only gives the maximal people that can be served, not the maximal seat assignment. We do the following changes to obtain the supply in the 
...
(1,2,3,4) in the 'people served in the table: 
1: Use the supply from stochastic model.(LP) 
2. Use the supply from stochastic model.(IP)
3: the inital supply from stochastic model, update the supply by deterministic model. 
4: set the mean demand as the initial supply, update the supply by deterministic model. 
