...
class CompareMethods:
    ...
    def random_generate(self):
        ...
        _, newx4 = m1.solveBenders(eps=1e-4, maxit=20)
        ...
        _, newx3 = deter.IP_formulation(np.zeros(self.I), ini_demand1)

        return sequence, newx3, newx4
        ...
        for num, j in enumerate(sequence):
            ...
            if newd[j-2] > 0:
                ...
                if decision_list:
                    ...
                    val_acc, newx1 = m_acc.solveBenders(eps=1e-4, maxit=20)
                    # newx 
                    ...
                    val_deny, newx0 = m_deny.solveBenders(eps=1e-4, maxit=20)
                    #  newx
