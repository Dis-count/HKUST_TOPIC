...
class deterministicModel:
    ...
    def dynamic_primal(self, dom_set, demand):
        ...
        y1 = m.addVars(self.given_lines, len(dom_set[0]), lb=0, vtype=GRB.CONTINUOUS, name = 'y1')
        y2 = m.addVars(self.given_lines, len(dom_set[1]), lb=0, vtype=GRB.CONTINUOUS)
