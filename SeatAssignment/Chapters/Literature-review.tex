...
% Firstly, The cutting stock problem.
%
% Secondly, for solving general method is branch and price. But branching scheme is not clear.
%
% Thus, we need find an efficient way to obtain optimal solution --Find the integer decomposition property/ round-up property.
