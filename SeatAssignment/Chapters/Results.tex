...
Data points: $x = (p_{1i}, p_{2i}, p_{3i}), i = $,

For each probability, we select 1, 20, 50 sequences to carry on the multiple linear regression.
...
\begin{table}[ht]
  ...
  \hline
  1  & -50.7086 & -29.1060 & -12.9784 & 171.3059 \\
  20 & -51.2565 & -29.4447 & -13.1312 &  171.6110 \\
  50 & -51.3270 & -29.3098 & -13.2226 & 171.5823 \\
  \hline
  \end{tabular}
\end{table}
