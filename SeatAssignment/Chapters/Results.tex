...
Explanation:
For the case of probability $[0.05, 0.05, 0.85, 0.05](c =2.9)$, the demand can be $[4, 1, 45, 2]$ or $[2, 2, 47, 1]$. We cannot construct all full patterns for every row.
...
Second stage: gap is becoming larger as $T$ increases. 

Third stage: As $T$ continues to increases, gap is becoming smaller when the capacity is limited.
