...
Now suppose the demand of groups is stochastic, following some unknown distribution. The stochastic information can be obtained from scenarios through historical data. To maximize the expected value of people over all the scenarios, we propose a two-stage scenario-based stochastic programming.
