...
When $|\Omega| =1$ in problem \ref{sto_form}, the stochastic programming will be 
...
Problem \ref{deter_upper} represents the deterministic model. Demand, $d_i, i = 1,\ldots,m$ is known in advance, our goal is to accommodate as many as people possible in the fixed rows.
