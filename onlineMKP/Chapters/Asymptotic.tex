...
= & 2 l M^2 \sum_{t=1}^{\theta T - T_0} 2 \exp \left(- \frac{\lambda_{\min}^2}{2 \delta^2 (N+1)^2} \cdot (\theta T-t)\right)+O(1).
\end{aligned}
$$
...
$$
\begin{aligned}
& 2 l M^2 \sum_{t=T_0}^{+\infty} 2 \exp \left(- \frac{\lambda_{\min}^2 t^2}{2 \delta^2 (N+1)^2 t}\right) + O(1) \\
