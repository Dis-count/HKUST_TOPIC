...
The core idea is to decompose the total loss over time and analyze the loss in each period.

Step 1: Loss Decomposition

% The proof defines a dynamic primal LP, whose optimal value equals the HO revenue
