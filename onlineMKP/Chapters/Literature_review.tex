...
Research on dynamic and stochastic variants of the Multiple Knapsack Problem (MKP) remains relatively limited. The literature can be broadly categorized into two streams. One stream focuses on dynamic online settings, where items arrive sequentially with no prior information, as seen in studies on the online multiple knapsack problem \citep{bienkowski2020optimal, sun2020competitive}. Another stream investigates stochastic models, such as the two-stage stochastic MKP with capacitated knapsacks across predefined scenarios \citep{tonissen2017column}. Our work bridges these aspects by considering a setting where the arrival probability of each item type is known in advance. This key information enables the development of more proactive and potentially more effective allocation strategies.
