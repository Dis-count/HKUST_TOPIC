...
Research on dynamic and stochastic variants of the Multiple Knapsack Problem (MKP) remains limited and can be divided into two main streams. The first addresses dynamic online settings where items arrive sequentially without prior information, as seen in studies on the online multiple knapsack problem \citep{bienkowski2020optimal, sun2020competitive}, which aim to develop competitive algorithms. The second investigates stochastic models, such as the two-stage stochastic MKP where the availability of knapsacks can vary across different scenarios \citep{tonissen2017column}. Departing from these, our work considers a setting with sequentially arriving items of known types and known arrival probabilities, enabling the design of proactive and more effective allocation strategies.
